...
<style>
  /* 1. 기본 초기화 & 폰트 */
  body {
    background-color: #f8f9fa !important; /* 전체 배경: 아주 연한 회색 */
    color: #333 !important;
  ...
  .tech-row:last-child { margin-bottom: 0; border: none; padding-bottom: 0; }
  ...
  @media (max-width: 768px) {
    .header-section { padding: 40px 20px; border-radius: 0; }
    .main-title { font-size: 32px; }
    .card { padding: 24px; }
    .tech-row { flex-direction: column; gap: 10px; }
    .post-card { flex-direction: column; align-items: flex-start; gap: 10px; }
  }
</style>
...
<div class="header-section">
  <div class="wrapper">
    ...
    <p class="sub-desc">
      ...
      핀테크 도구 <a href="https://sudanghelp.co.kr/" target="_blank" style="color: #60a5fa; font-weight: bold; border-bottom: 1px solid #60a5fa;">[수당헬프]</a>를 개발하는 <strong>Seansble</strong>입니다.<br>
